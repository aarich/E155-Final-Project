...
int main(void)
{
    ...
    if (data == NULL)
        ...
        printf("<P>Chars to be transmitted (may be invisible): <br>r: %c <br>l: %c <br>t: %c</p>", r, l, t);
...
packages installed: bluez, python-dev, python-bluez (maybe bluetooth is needed?)
*/